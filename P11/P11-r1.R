#Práctica 11: frentes de Pareto. Reto 1. Código base en Ref. [1,3].
...
png("p11-frente-subcj.png")
plot(val[,1], val[,2], xlab=paste(xl,""),
     ylab=paste(yl,""))
points(frente[,1], frente[,2], col="pink", pch=16, cex=1.5)
points(subconjunto[,1], subconjunto[,2], col="purple", pch=16, cex=1.5)
graphics.off()